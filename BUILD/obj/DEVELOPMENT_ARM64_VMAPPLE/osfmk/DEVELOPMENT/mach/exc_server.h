...
extern
#endif	/* mig_external */
mig_kern_routine_t exc_server_routine(
		mach_msg_header_t *InHeadP);
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_port_descriptor_t thread;
		mach_msg_port_descriptor_t task;
	} __RequestKData__exception_raise_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	} __RequestUData__exception_raise_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__exception_raise_state_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		natural_t old_state[1296];
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__exception_raise_state_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_port_descriptor_t thread;
		mach_msg_port_descriptor_t task;
	} __RequestKData__exception_raise_state_identity_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		natural_t old_state[1296];
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__exception_raise_state_identity_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__exception_raise_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__exception_raise_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__exception_raise_state_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		natural_t new_state[1296];
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__exception_raise_state_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__exception_raise_state_identity_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		natural_t new_state[1296];
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__exception_raise_state_identity_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
