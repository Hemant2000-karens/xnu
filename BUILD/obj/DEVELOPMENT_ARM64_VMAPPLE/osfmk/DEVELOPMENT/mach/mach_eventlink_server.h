...
extern
#endif	/* mig_external */
mig_kern_routine_t mach_eventlink_server_routine(
		mach_msg_header_t *InHeadP);
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_eventlink_create_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	} __RequestUData__mach_eventlink_create_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_eventlink_destroy_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_eventlink_destroy_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_body_t msgh_body;
		mach_msg_port_descriptor_t thread;
	} __RequestKData__mach_eventlink_associate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_eventlink_associate_option_t option;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_eventlink_associate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_eventlink_disassociate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_eventlink_disassociate_option_t option;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_eventlink_disassociate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_body_t msgh_body;
		mach_msg_port_descriptor_t eventlink_pair[2];
	} __ReplyKData__mach_eventlink_create_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_eventlink_create_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_eventlink_destroy_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_eventlink_destroy_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_eventlink_associate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_eventlink_associate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_eventlink_disassociate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_eventlink_disassociate_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
