...
#define	resource_notify_MSG_COUNT	6
...
extern
#endif	/* mig_external */
kern_return_t send_port_space_violation
(
	mach_port_t receiver,
	proc_name_t procname,
	int pid,
...
extern
#endif	/* mig_external */
kern_return_t send_file_descriptors_violation
(
	mach_port_t receiver,
	proc_name_t procname,
	int pid,
...
extern
#endif	/* mig_external */
kern_return_t send_kqworkloops_violation
(
	mach_port_t receiver,
	proc_name_t procname,
	int pid,
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int64_t ports_allowed;
		resource_notify_flags_t flags;
	} __Request__port_space_violation_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int64_t filedesc_allowed;
		resource_notify_flags_t flags;
	} __Request__file_descriptors_violation_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int64_t kqworkloops_allowed;
		resource_notify_flags_t flags;
	} __Request__kqworkloops_violation_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __RequestUnion__send_resource_notify_subsystem {
	...
	__Request__port_space_violation_t Request_send_port_space_violation;
	__Request__file_descriptors_violation_t Request_send_file_descriptors_violation;
	__Request__kqworkloops_violation_t Request_send_kqworkloops_violation;
};
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		kern_return_t RetCode;
	} __Reply__port_space_violation_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		kern_return_t RetCode;
	} __Reply__file_descriptors_violation_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		kern_return_t RetCode;
	} __Reply__kqworkloops_violation_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __ReplyUnion__send_resource_notify_subsystem {
	...
	__Reply__port_space_violation_t Reply_send_port_space_violation;
	__Reply__file_descriptors_violation_t Reply_send_file_descriptors_violation;
	__Reply__kqworkloops_violation_t Reply_send_kqworkloops_violation;
};
#endif /* !__RequestUnion__send_resource_notify_subsystem__defined */
...
#define subsystem_to_name_map_resource_notify \
    ...
    { "port_space_violation", 827803 },\
    { "file_descriptors_violation", 827804 },\
    { "kqworkloops_violation", 827805 }
#endif
