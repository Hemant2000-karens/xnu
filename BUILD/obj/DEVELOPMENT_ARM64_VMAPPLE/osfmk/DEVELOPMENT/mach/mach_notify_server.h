...
extern
#endif	/* mig_external */
mig_kern_routine_t notify_server_routine(
		mach_msg_header_t *InHeadP);
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_notify_port_deleted_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	} __RequestUData__mach_notify_port_deleted_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_body_t msgh_body;
		mach_msg_port_descriptor_t rights;
	} __RequestKData__mach_notify_port_destroyed_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_notify_port_destroyed_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_notify_no_senders_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_port_mscount_t mscount;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_notify_no_senders_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_notify_send_once_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_notify_send_once_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_notify_dead_name_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_port_name_t name;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_notify_dead_name_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_notify_port_deleted_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_notify_port_deleted_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_notify_port_destroyed_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_notify_port_destroyed_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_notify_no_senders_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_notify_no_senders_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_notify_send_once_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_notify_send_once_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_notify_dead_name_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_notify_dead_name_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
