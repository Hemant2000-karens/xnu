...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__mach_exc_subsystem__
#if !defined(__MIG_check__Reply__mach_exception_raise_identity_protected_t__defined)
#define __MIG_check__Reply__mach_exception_raise_identity_protected_t__defined

mig_internal kern_return_t __MIG_check__Reply__mach_exception_raise_identity_protected_t(__Reply__mach_exception_raise_identity_protected_t *Out0P)
{

	typedef __Reply__mach_exception_raise_identity_protected_t __Reply __attribute__((unused));
	if (Out0P->Head.msgh_id != 2508) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__mach_exception_raise_identity_protected_t__defined) */
#endif /* __MIG_check__Reply__mach_exc_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine mach_exception_raise_identity_protected */
mig_external kern_return_t mach_exception_raise_identity_protected
(
	mach_port_t exception_port,
	uint64_t thread_id,
...
#pragma pack(pop)
...
#ifdef	__MIG_check__Reply__mach_exception_raise_identity_protected_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__mach_exception_raise_identity_protected_t__defined */

	__DeclareSendRpc(2408, "mach_exception_raise_identity_protected")

#if	UseStaticTemplates
	const static mach_msg_port_descriptor_t task_id_token_tTemplate = {
		/* name = */		MACH_PORT_NULL,
		/* pad1 = */		0,
		/* pad2 = */		0,
		/* disp = */		19,
...
#if	UseStaticTemplates
	InP->task_id_token_t = task_id_token_tTemplate;
	InP->task_id_token_t.name = task_id_token_t;
#else	/* UseStaticTemplates */
	InP->task_id_token_t.name = task_id_token_t;
	InP->task_id_token_t.disposition = 19;
	InP->task_id_token_t.type = MACH_MSG_PORT_DESCRIPTOR;
#endif	/* UseStaticTemplates */
	...
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = exception_port;
	InP->Head.msgh_id = 2408;
	InP->Head.msgh_reserved = 0;

	__BeforeSendRpc(2408, "mach_exception_raise_identity_protected")
#if	(__MigKernelSpecificCode) || (_MIG_KERNELSPECIFIC_CODE_)
	msg_result = mach_msg_rpc_from_kernel(&InP->Head, msgh_size, (mach_msg_size_t)sizeof(Reply));
#else
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
#endif /* __MigKernelSpecificCode */
	__AfterSendRpc(2408, "mach_exception_raise_identity_protected")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
	}
	if (msg_result != MACH_MSG_SUCCESS) {
...
#if	defined(__MIG_check__Reply__mach_exception_raise_identity_protected_t__defined)
	check_result = __MIG_check__Reply__mach_exception_raise_identity_protected_t((__Reply__mach_exception_raise_identity_protected_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS) {
#if	__MigKernelSpecificCode
		mach_msg_destroy_from_kernel(&Out0P->Head);
#endif	/* __MigKernelSpecificCode */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__mach_exc_subsystem__
#if !defined(__MIG_check__Reply__mach_exception_raise_backtrace_t__defined)
#define __MIG_check__Reply__mach_exception_raise_backtrace_t__defined

mig_internal kern_return_t __MIG_check__Reply__mach_exception_raise_backtrace_t(__Reply__mach_exception_raise_backtrace_t *Out0P)
{

	typedef __Reply__mach_exception_raise_backtrace_t __Reply __attribute__((unused));
	if (Out0P->Head.msgh_id != 2509) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__mach_exception_raise_backtrace_t__defined) */
#endif /* __MIG_check__Reply__mach_exc_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine mach_exception_raise_backtrace */
mig_external kern_return_t mach_exception_raise_backtrace
(
	mach_port_t exception_port,
...
#pragma pack(pop)
...
#ifdef	__MIG_check__Reply__mach_exception_raise_backtrace_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__mach_exception_raise_backtrace_t__defined */

	__DeclareSendRpc(2409, "mach_exception_raise_backtrace")

#if	UseStaticTemplates
	const static mach_msg_port_descriptor_t kcdata_object_tTemplate = {
		/* name = */		MACH_PORT_NULL,
		/* pad1 = */		0,
		/* pad2 = */		0,
		/* disp = */		19,
	...
	InP->msgh_body.msgh_descriptor_count = 1;
#if	UseStaticTemplates
	InP->kcdata_object_t = kcdata_object_tTemplate;
	InP->kcdata_object_t.name = kcdata_object_t;
#else	/* UseStaticTemplates */
	InP->kcdata_object_t.name = kcdata_object_t;
	InP->kcdata_object_t.disposition = 19;
	InP->kcdata_object_t.type = MACH_MSG_PORT_DESCRIPTOR;
#endif	/* UseStaticTemplates */
	...
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = exception_port;
	InP->Head.msgh_id = 2409;
	InP->Head.msgh_reserved = 0;

	__BeforeSendRpc(2409, "mach_exception_raise_backtrace")
#if	(__MigKernelSpecificCode) || (_MIG_KERNELSPECIFIC_CODE_)
	msg_result = mach_msg_rpc_from_kernel(&InP->Head, msgh_size, (mach_msg_size_t)sizeof(Reply));
#else
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
#endif /* __MigKernelSpecificCode */
	__AfterSendRpc(2409, "mach_exception_raise_backtrace")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
	}
	if (msg_result != MACH_MSG_SUCCESS) {
...
#if	defined(__MIG_check__Reply__mach_exception_raise_backtrace_t__defined)
	check_result = __MIG_check__Reply__mach_exception_raise_backtrace_t((__Reply__mach_exception_raise_backtrace_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS) {
#if	__MigKernelSpecificCode
		mach_msg_destroy_from_kernel(&Out0P->Head);
#endif	/* __MigKernelSpecificCode */
...
#if ( __MigTypeCheck )
#if __MIG_check__Reply__mach_exc_subsystem__
#if !defined(__MIG_check__Reply__mach_exception_raise_state_identity_protected_t__defined)
#define __MIG_check__Reply__mach_exception_raise_state_identity_protected_t__defined

mig_internal kern_return_t __MIG_check__Reply__mach_exception_raise_state_identity_protected_t(__Reply__mach_exception_raise_state_identity_protected_t *Out0P)
{

	typedef __Reply__mach_exception_raise_state_identity_protected_t __Reply __attribute__((unused));
#if	__MigTypeCheck
	unsigned int msgh_size;
#endif	/* __MigTypeCheck */

	if (Out0P->Head.msgh_id != 2510) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#endif /* !defined(__MIG_check__Reply__mach_exception_raise_state_identity_protected_t__defined) */
#endif /* __MIG_check__Reply__mach_exc_subsystem__ */
#endif /* ( __MigTypeCheck ) */


/* Routine mach_exception_raise_state_identity_protected */
mig_external kern_return_t mach_exception_raise_state_identity_protected
(
	mach_port_t exception_port,
	uint64_t thread_id,
	mach_port_t task_id_token_t,
...
#pragma pack(pop)
	...
	union mach_exception_raise_state_identity_protectedMessU {
		Request In;
		Reply Out;
	} *Mess = (union mach_exception_raise_state_identity_protectedMessU *) mig_user_allocate(sizeof(*Mess));
...
#ifdef	__MIG_check__Reply__mach_exception_raise_state_identity_protected_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__mach_exception_raise_state_identity_protected_t__defined */

	__DeclareSendRpc(2410, "mach_exception_raise_state_identity_protected")
	...
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = exception_port;
	InP->Head.msgh_id = 2410;
	InP->Head.msgh_reserved = 0;

	__BeforeSendRpc(2410, "mach_exception_raise_state_identity_protected")
#if	(__MigKernelSpecificCode) || (_MIG_KERNELSPECIFIC_CODE_)
	msg_result = mach_msg_rpc_from_kernel(&InP->Head, msgh_size, (mach_msg_size_t)sizeof(Reply));
#else
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
#endif /* __MigKernelSpecificCode */
	__AfterSendRpc(2410, "mach_exception_raise_state_identity_protected")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
	}
	if (msg_result != MACH_MSG_SUCCESS) {
...
#if	defined(__MIG_check__Reply__mach_exception_raise_state_identity_protected_t__defined)
	check_result = __MIG_check__Reply__mach_exception_raise_state_identity_protected_t((__Reply__mach_exception_raise_state_identity_protected_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS) {
#if	__MigKernelSpecificCode
		mach_msg_destroy_from_kernel(&Out0P->Head);
#endif	/* __MigKernelSpecificCode */
