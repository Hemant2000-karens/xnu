...
#endif	/* mig_external */
MIG_SERVER_ROUTINE
kern_return_t mach_memory_entry_ownership_from_user
(
	mem_entry_name_port_t mem_entry,
	mach_port_t owner,
	int ledger_tag,
...
extern
#endif	/* mig_external */
mig_kern_routine_t memory_entry_server_routine(
		mach_msg_header_t *InHeadP);
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_memory_entry_purgable_control_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	} __RequestUData__mach_memory_entry_purgable_control_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__mach_memory_entry_access_tracking_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int access_tracking;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_memory_entry_access_tracking_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int ledger_tag;
		int ledger_flags;
	} __Request__mach_memory_entry_ownership_from_user_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for kernel processed data (Header + Descriptors) */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_body_t msgh_body;
		mach_msg_port_descriptor_t owner;
	} __RequestKData__mach_memory_entry_ownership_from_user_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int ledger_flags;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__mach_memory_entry_ownership_from_user_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __RequestUnion__memory_entry_subsystem {
	...
	__Request__mach_memory_entry_ownership_from_user_t Request_mach_memory_entry_ownership_from_user;
};
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_memory_entry_purgable_control_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int state;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_memory_entry_purgable_control_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_memory_entry_access_tracking_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		uint32_t access_tracking_writes;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_memory_entry_access_tracking_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		kern_return_t RetCode;
	} __Reply__mach_memory_entry_ownership_from_user_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for kernel processed data (Header + Descriptors) */
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__mach_memory_entry_ownership_from_user_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__mach_memory_entry_ownership_from_user_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __ReplyUnion__memory_entry_subsystem {
	...
	__Reply__mach_memory_entry_ownership_from_user_t Reply_mach_memory_entry_ownership_from_user;
};
...
#define subsystem_to_name_map_memory_entry \
    ...
    { "mach_memory_entry_ownership_from_user", 4902 }
#endif
