...
extern
#endif	/* mig_external */
mig_kern_routine_t UNDReply_server_routine(
		mach_msg_header_t *InHeadP);
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		mach_msg_body_t msgh_body;
		mach_msg_ool_descriptor_t data;
	} __RequestKData__UNDAlertCompletedWithResult_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	} __RequestUData__UNDAlertCompletedWithResult_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __RequestKData__UNDNotificationCreated_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		int userLandNotificationKey;
		char padding[0]; /* Avoid generating empty UData structs */
	} __RequestUData__UNDNotificationCreated_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__UNDAlertCompletedWithResult_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__UNDAlertCompletedWithResult_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __ReplyKData__UNDNotificationCreated_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
/* Struct for pure user data */
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		char padding[0]; /* Avoid generating empty UData structs */
	} __ReplyUData__UNDNotificationCreated_rpc_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
